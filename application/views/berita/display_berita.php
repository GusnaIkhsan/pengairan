                            ...
                            <header class="kingster-single-article-head clearfix">
                                ...
                                <div class="kingster-single-article-head-right">
                                    ...
                                    <div class="kingster-blog-info-wrapper">
                                        ...
                                        <div class="kingster-blog-info kingster-blog-info-font kingster-blog-info-tag "><a href="#" rel="tag">Berita</a></div>
                ...
                <div class="kingster-breadcrumbs">
                    <div class="kingster-breadcrumbs-container kingster-container">
                        <div class="kingster-breadcrumbs-item kingster-item-pdlr"> <span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to Kingster." href="<?php echo base_url(); ?>" class="home"><span property="name">Beranda</span></a>
                            ...
                            </span>&gt;<span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to the Blog category archives." href="<?php echo base_url('all-news'); ?>" class="taxonomy category"><span property="name">Berita</span></a>
                                    ...
                                    <article id="post-1268" class="post-1268 post type-post status-publish format-standard has-post-thumbnail hentry category-blog category-post-format tag-news">
                                        <div class="kingster-single-article clearfix">
                                            ...
                                            <?php echo $berita['isi_berita']; ?>
                                                ...
                                                <p><img class="alignnone size-full wp-image-5422" src="" alt="" width="1700" height="810" /></p> <span class="gdlr-core-space-shortcode" style="margin-top: 30px ;"></span>
                            ...
                            <div class="kingster-bottom-page-builder-content kingster-item-pdlr">
                                ...
                                <div class="kingster-single-author clearfix">
                                    <div class="kingster-single-author-wrap">
                                        <div class="kingster-single-author-avartar kingster-media-image"><img alt='' src='<?php echo base_url('asset/upload/avatar.jpg'); ?>' class='avatar avatar-90 photo' height='90' width='90' /></div>
                                    ...
                                    <ol class="comment-list">
                                        <li class="comment byuser comment-author-superuser bypostauthor even thread-even depth-1" id="li-comment-7">
                                            <article id="comment-7" class="comment-article">
                                                <div class="comment-avatar"><img alt='' src='<?php echo base_url('asset/upload/avatar.jpeg'); ?>' class='avatar avatar-90 photo' height='90' width='90' /></div>
