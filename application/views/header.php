                    ...
                    <div class="kingster-top-bar-container-inner clearfix">
                        ...
                        <div class="kingster-top-bar-right kingster-item-pdlr">
                            <ul id="kingster-top-bar-menu" class="sf-menu kingster-top-bar-menu kingster-top-bar-right-menu">
                                <li class="menu-item kingster-normal-menu"><a href="#">UB Official</a></li>
                                <li class="menu-item kingster-normal-menu"><a href="#">BITS</a></li>
                                <li class="menu-item kingster-normal-menu"><a href="#">Webmail</a></li>
                                <li class="menu-item kingster-normal-menu"><a href="#">UB News</a></li>
                            </ul>
                                ...
                                <ul id="menu-main-navigation-1" class="sf-menu">
                                    ...
                                    <!-- <li class="menu-item menu-item-has-children kingster-mega-menu"><a href="bachelor-of-science-in-business-administration.html" class="sf-with-ul-pre">Program Studi</a>
                                        <div class="sf-mega sf-mega-full megaimg">
                                            <ul class="sub-menu">
                                                <li class="menu-item menu-item-has-children" data-size="15"><a href="<?php echo base_url('sarjana'); ?>" class="sf-with-ul-pre">Sarjana (S1)</a>
                                                    <ul class="sub-menu">
                                                ...
                                                <li class="menu-item menu-item-has-children" data-size="15"><a href="<?php echo base_url('magister'); ?>" class="sf-with-ul-pre">Magister (S2)</a>
                                                    <ul class="sub-menu">
                                                ...
                                                <li class="menu-item menu-item-has-children" data-size="15"><a href="<?php echo base_url('doktor'); ?>" class="sf-with-ul-pre">Doctor (S3)</a>
                                                    <ul class="sub-menu">
