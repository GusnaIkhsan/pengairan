                ...
                <div class="kingster-breadcrumbs">
                    <div class="kingster-breadcrumbs-container kingster-container">
                        <div class="kingster-breadcrumbs-item kingster-item-pdlr">
                            ...
                            &gt;
                            <span property="itemListElement" typeof="ListItem">
                                <span property="name">Akademik</span>
                                <meta property="position" content="2">
                            </span>
                            &gt;
                            <span property="itemListElement" typeof="ListItem">
                                <span property="name">Program Studi Sarjana</span>
                                                ...
                                                <div class="gdlr-core-pbf-element">
                                                    <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr">
                                                        <div class="gdlr-core-title-item-title-wrap clearfix">
                                                            <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 29px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none; margin-left: -21px;">Sarjana Teknik Pengairan</h3>                                                            
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="gdlr-core-pbf-element">
                                                    <div class="gdlr-core-blog-item gdlr-core-item-pdb clearfix  gdlr-core-style-blog-full-with-frame" style="padding-bottom: 40px ;">
                                                        <div class="gdlr-core-blog-item-holder gdlr-core-js-2 clearfix" data-layout="fitrows" style="text-align: justify;">                                                            
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <p>Menyelenggarakan pendidikan yang berkualitas untuk menghasilkan lulusan dengan kemampuan akademik dan kompetensi terapan di bidang pengairan yang berwawasan lingkungan.</p>
                                                                </li>
                                                                <li>
                                                                    <p>Melakukan penelitian, pengembangan dan penyebarluasan ilmu pengetahuan dan teknologi, serta melaksanakan kegiatan pengabdian kepada masyarakat khususnya di bidang pemanfaatan dan pengelolaan sumber daya air untuk kesejahteraan rakyat.</p>
                                                                </li>
                                                            </ul>
                                                            <br>
                                                            <h5><b>Tujuan</b></h5>
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <p>Menghasilkan lulusan yang unggul, tangguh dan mampu bersaing di tingkat nasional, regional dan internasional yang berkaitan dengan perencanaan, perancangan, pelaksanaan, pengoperasian dan pemeliharaan serta pengembangan sumber daya air, berbudi pekerti luhur, serta bertakwa kepada Tuhan Yang Maha Esa.</p>
                                                                </li>
                                                                <li>
                                                                    <p>Memberikan kontribusi nyata dalam pengembangan ilmu dan teknologi bidang pengairan dalam kegiatan pengabdian kepada masyarakat, sehingga dapat berperan aktif dan parisipatif dalam menentukan arah kebijakan nasional khususnya dalam bidang pengairan.</p>
                                                                </li>
                                                                <li>
                                                                    <p>Menghasilkan lulusan yang mempunyai kemauan dan kemampuan membelajarkan dan mengembangkan diri (life-long learning), peka dan bersikap terbuka terhadap perubahan-perubahan dengan tetap menjaga jati diri.</p>
                                                                </li>
                                                            </ul>                                                                                          
                                                        </div>                                  
                                                    </div>
