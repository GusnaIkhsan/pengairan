                            ...
                            <div
                                ...
                                <div class="gdlr-core-title-item-title-wrap clearfix">
                                    <h3 class="gdlr-core-title-item-title gdlr-core-skin-title "
                                        style="font-size: 75px ;font-weight: 700 ;color: #ffffff ;">Contact Us</h3>
                                ...
                                <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                                    <div class="gdlr-core-pbf-element">
                                        <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr"
                                            ...
                                            <div class="gdlr-core-title-item-title-wrap clearfix">
                                                <h3 class="gdlr-core-title-item-title gdlr-core-skin-title "
                                                    style="font-size: 32px ;font-weight: 700 ;">Leave us your info</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="gdlr-core-pbf-element">
                                            ...
                                            <ul>
                                                <li class=" gdlr-core-skin-divider gdlr-core-with-hover"><span
                                                    ...
                                                    <div class="gdlr-core-icon-list-content-wrap"><span
                                                            ...
                                                            style="font-size: 16px ;">contact@infinitewptheme.com</span>
                                                    </div>
                                                </li>
                                                <li class=" gdlr-core-skin-divider gdlr-core-with-hover"><span
                                                        class="gdlr-core-icon-list-icon-wrap"><i
                        ...
                        <div class="gdlr-core-pbf-element">
                            <div class="gdlr-core-social-network-item gdlr-core-item-pdb  gdlr-core-center-align gdlr-core-item-pdlr"
                                style="padding-bottom: 0px ;"><a href="mailto:#" target="_blank"
                                    ...
                                    style="font-size: 20px ;color: #232323 ;"><i class="fa fa-envelope"></i></a><a href="#"
