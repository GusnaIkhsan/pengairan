            ...
            <div class="kingster-breadcrumbs">
                <div class="kingster-breadcrumbs-container kingster-container">
                    <div class="kingster-breadcrumbs-item kingster-item-pdlr"> <span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to Kingster." href="<?php echo base_url('beranda'); ?>" class="home"><span property="name">Beranda</span></a>
                        ...
                        </span>&gt;<span property="itemListElement" typeof="ListItem"><span property="name">Visi, Misi, Tujuan</span>
                        ...
                        <div class="gdlr-core-pbf-wrapper-content gdlr-core-js ">
                            <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                                    <div class="gdlr-core-pbf-element">
                                        <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr">
                                            <div class="gdlr-core-title-item-title-wrap clearfix">
                                                <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 29px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;">Visi</h3></div>
                                        </div>
                                    </div>
                                    <div class="gdlr-core-pbf-element">
                                        <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                            <div class="gdlr-core-text-box-item-content" style="font-size: 16px ;text-transform: none ;">
                                                <p>Jurusan Teknik Pengairan menjadi institusi pendidikan tinggi di bidang pengairan (sumber daya air) yang unggul di tingkat regional dan internasional, dan menghasilkan lulusan yang bermoral, berkompeten, dan inovatif, melalui tri dharma perguruan tinggi (Pendidikan, Penelitian dan Pengabdian Kepada Masyarakat).</p>                                                                                                
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="gdlr-core-pbf-element">
                                        <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr">
                                            <div class="gdlr-core-title-item-title-wrap clearfix">
                                                <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 29px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;">Misi</h3></div>
                                        </div>
                                    </div>
                                    <div class="gdlr-core-pbf-element">
                                        <div class="gdlr-core-icon-list-item gdlr-core-item-pdlr gdlr-core-item-pdb clearfix " style="padding-bottom: 25px ;">
                                            <ul>
                                                <li class=" gdlr-core-skin-divider" style="margin-bottom: 22px ;"><span class="gdlr-core-icon-list-icon-wrap" style="margin-top: 5px ;"><i class="gdlr-core-icon-list-icon fa fa-dot-circle-o" style="color: #50bd77 ;font-size: 18px ;width: 18px ;" ></i></span>
                                                    <div class="gdlr-core-icon-list-content-wrap"><span class="gdlr-core-icon-list-content" style="font-size: 17px ;">Menyelenggarakan pendidikan yang berkualitas untuk menghasilkan lulusan dengan kemampuan akademik dan kompetensi terapan di bidang pengairan yang berwawasan lingkungan.</span></div>
                                                </li>
                                                <li class=" gdlr-core-skin-divider" style="margin-bottom: 22px ;"><span class="gdlr-core-icon-list-icon-wrap" style="margin-top: 5px ;"><i class="gdlr-core-icon-list-icon fa fa-dot-circle-o" style="color: #50bd77 ;font-size: 18px ;width: 18px ;" ></i></span>
                                                    <div class="gdlr-core-icon-list-content-wrap"><span class="gdlr-core-icon-list-content" style="font-size: 17px ;">Melakukan penelitian, pengembangan dan penyebarluasan ilmu pengetahuan dan teknologi, serta melaksanakan kegiatan pengabdian kepada masyarakat khususnya di bidang pemanfaatan dan pengelolaan sumber daya air untuk kesejahteraan rakyat.</span></div>
                                                </li>                                                        
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="gdlr-core-pbf-element">
                                        <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr">
                                            <div class="gdlr-core-title-item-title-wrap clearfix">
                                                <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 29px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;">Tujuan</h3></div>
                                        </div>
                                    </div>                         
                                    <div class="gdlr-core-pbf-element">
                                        <div class="gdlr-core-icon-list-item gdlr-core-item-pdlr gdlr-core-item-pdb clearfix " style="padding-bottom: 25px ;">
                                            <div class="gdlr-core-text-box-item-content" style="font-size: 16px ;text-transform: none ;">
                                                <p>Program Pendidikan Sarjana Teknik Pengairan mempunyai tujuan khusus dalam menghasilkan lulusan yang berkompentensi sebagai yang tercermin dalam Tabel Struktur Kompetensi Mata kuliah Jurusan Teknik Pengairan, sehingga para lulusan:</p>                                                                                                
                                            </div>
                                            <ul>
                                                <li class=" gdlr-core-skin-divider" style="margin-bottom: 22px ;"><span class="gdlr-core-icon-list-icon-wrap" style="margin-top: 5px ;"><i class="gdlr-core-icon-list-icon fa fa-dot-circle-o" style="color: #50bd77 ;font-size: 18px ;width: 18px ;" ></i></span>
                                                    <div class="gdlr-core-icon-list-content-wrap"><span class="gdlr-core-icon-list-content" style="font-size: 17px ;">Menghasilkan lulusan yang unggul, tangguh dan mampu bersaing di tingkat nasional, regional dan internasional yang berkaitan dengan perencanaan, perancangan, pelaksanaan, pengoperasian dan pemeliharaan serta pengembangan sumber daya air, berbudi pekerti luhur, serta bertakwa kepada Tuhan Yang Maha Esa.</span></div>
                                                </li>
                                                <li class=" gdlr-core-skin-divider" style="margin-bottom: 22px ;"><span class="gdlr-core-icon-list-icon-wrap" style="margin-top: 5px ;"><i class="gdlr-core-icon-list-icon fa fa-dot-circle-o" style="color: #50bd77 ;font-size: 18px ;width: 18px ;" ></i></span>
                                                    <div class="gdlr-core-icon-list-content-wrap"><span class="gdlr-core-icon-list-content" style="font-size: 17px ;">Memberikan kontribusi nyata dalam pengembangan ilmu dan teknologi bidang pengairan dalam kegiatan pengabdian kepada masyarakat, sehingga dapat berperan aktif dan parisipatif dalam menentukan arah kebijakan nasional khususnya dalam bidang pengairan.</span></div>
                                                </li>                                                        
                                                <li class=" gdlr-core-skin-divider" style="margin-bottom: 22px ;"><span class="gdlr-core-icon-list-icon-wrap" style="margin-top: 5px ;"><i class="gdlr-core-icon-list-icon fa fa-dot-circle-o" style="color: #50bd77 ;font-size: 18px ;width: 18px ;" ></i></span>
                                                    <div class="gdlr-core-icon-list-content-wrap"><span class="gdlr-core-icon-list-content" style="font-size: 17px ;">Menghasilkan lulusan yang mempunyai kemauan dan kemampuan membelajarkan dan mengembangkan diri (life-long learning), peka dan bersikap terbuka terhadap perubahan-perubahan dengan tetap menjaga jati diri.</span></div>
                                                </li>                                                        
                                            </ul>
                                        </div>
                                    </div>
