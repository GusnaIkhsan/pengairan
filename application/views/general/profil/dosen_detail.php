            ...
            <div class="kingster-body-wrapper clearfix  kingster-with-frame">
                ...
                <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" id="div_983a_0">
                    ...
                    <div class="kingster-page-title-container kingster-container">
                        <div class="kingster-page-title-content kingster-item-pdlr" id="div_983a_1">
                            ...
                            <h1 class="kingster-page-title" id="h1_983a_0">Detail Dosen</h1>
                        </div>
                    </div>
                </div>
                ...
                <div class="kingster-page-wrapper" id="kingster-page-wrapper">
                    <div class="gdlr-core-page-builder-body">
                        ...
                        <div class="gdlr-core-pbf-wrapper" id="div_1dd7_79" style="margin-top: -50px;">
                                        ...
                                        <div class="gdlr-core-tab-item gdlr-core-js gdlr-core-item-pdb  gdlr-core-left-align gdlr-core-tab-style1-horizontal gdlr-core-item-pdlr">
                                            ...
                                            <div class="gdlr-core-tab-item-wrap">
                                                <div class="gdlr-core-tab-item-title-wrap clearfix gdlr-core-title-font">
                                                    <div class="gdlr-core-tab-item-title  gdlr-core-active" data-tab-id="1">Pendidikan</div>
                                                    <div class="gdlr-core-tab-item-title " data-tab-id="2">Penghargaan</div>
                                                    <div class="gdlr-core-tab-item-title " data-tab-id="3">Penelitian</div>
                                                    <div class="gdlr-core-tab-item-title " data-tab-id="4">Publikasi</div>
                                                    <div class="gdlr-core-tab-item-title " data-tab-id="5">Link Publikasi</div>
                                                    <div class="gdlr-core-tab-item-title " data-tab-id="6">Buku</div>
                                                    <div class="gdlr-core-tab-item-title " data-tab-id="7">Pengabdian</div>                                          
                                                </div>
