    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Level</th>                    <td>"; if ($rows['level']=='admin'){ echo "<input type='radio' name='g' value='admin' checked> Admin &nbsp; <input type='radio' name='g' value='superadmin'> Super Admin &nbsp;"; }else{ echo "<input type='radio' name='g' value='admin'> Admin &nbsp; <input type='radio' name='g' value='superadmin' checked> Super Admin &nbsp;"; } echo "</td></tr>
